...
#define     GREEN        0X07Ee	  //绿色
#define     BLUE         0X001e	  //蓝色
#define     WHITE        0XFFFe	  //白色
...
#define     PORPO        0X801e	  //紫色
#define     PINK         0XF81e	  //粉红色
#define     GRAYBLUE     0X5458   //灰蓝色
#define     LGRAYBLUE    0XA651   //浅灰蓝色
#define     DARKBLUE     0X01Ce	  //深灰蓝色
...
#define LCD_RST_H()		sbi(PE_ODR,3);
#define LCD_RST_L()		cbi(PE_ODR,3);

#define LCD_RS_H()		sbi(PE_ODR,4);
#define LCD_RS_L()		cbi(PE_ODR,4);


#define LCD_CS_H()		sbi(PH_ODR,2);
#define LCD_CS_L()		cbi(PH_ODR,2);
